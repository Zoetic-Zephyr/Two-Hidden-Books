...
class Boid {
  ...
  int touchTexts () {
    if (this.pos.x <= text1X + text1W/2 && this.pos.x >= text1X - text1W/2 && 
      this.pos.y <= text1Y + text1H/2 && this.pos.y >= text1Y - text1H/2 ) {
      return 1;
    } else if (this.pos.x <= text2X + text2W/2 && this.pos.x >= text2X - text2W/2 && 
  ...
  void leaveText(int textID) {
    ...
    if (textID == 1) {
      centerPos = new PVector(text1X, text1Y);
    } else if (textID == 2) {
      centerPos = new PVector(text2X, text2Y);
    }
